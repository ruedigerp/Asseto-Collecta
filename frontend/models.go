...
// Page Data Structure - Einheitlich für alle Templates
type PageData struct {
	...
	// Single Items (Pointer für optional)
	Asset    *Asset    // Für einzelne Asset-Ansichten
	Employee *Employee // Für einzelne Employee-Ansichten
